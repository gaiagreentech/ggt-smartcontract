...
import "./weeecycle.sol";
import "@openzeppelin/contracts/token/ERC721/ERC721.sol";
import "@openzeppelin/contracts/utils/Strings.sol";
import "@openzeppelin/contracts/security/ReentrancyGuard.sol";
import "@openzeppelin/contracts/utils/Counters.sol";

contract WEEEMarket is ReentrancyGuard {
    ...
    function createMarketItem(
        ...
        require(msg.value == listingFee, string.concat("price!==msg.value.msg.value:" , Strings.toString(msg.value), ".price:", Strings.toString(listingFee)));
        _marketItemIds.increment();
        uint256 marketItemId = _marketItemIds.current();

        address creator = WEEECycleNFT(nftContractAddress).ownerOf(tokenId);
